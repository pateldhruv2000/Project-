...
input_path = "/home/sagemaker-user/dice_model_project/Project-/output/staged_csvs/status_code.csv"
output_dir = "/home/sagemaker-user/dice_model_project/Project-/output/raw_vault/reference/"

# Output file name
ref_filename = "ref_play_session_status_code.parquet"
...
print(f"✅ Reference Table for Play Session Status Code created successfully!\nReference File: {ref_filename}")
